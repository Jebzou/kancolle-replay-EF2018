var MAPDATA = {
	...
	42: {
		...
		maps: {
			1: {
				name: 'E-1',
				nameT: 'Operation Preparations! Securing the Rear Area Supply Lines',
				fleetTypes: [0],
				bgmMap: 119,
				bgmDN: 120,
				bgmNN: 120,
			...
			3: {
				name: 'E-3',
				nameT: 'Strike the Enemy\'s Western Frontline Anchorage!',
				fleetTypes: [0,1,2,3],
				bgmMap: 119,
				bgmDN: 120,
				bgmNN: 120,
			...
			4: {
				...
				additionalChecks: function(ships, errors){
					errors.push('Map not released yet');
				},
				nodes: {
